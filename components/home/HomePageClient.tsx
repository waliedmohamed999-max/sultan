...
export function HomePageClient({ initialContent }: { initialContent: SiteContent }) {
  ...
  return (
    <>
      ...
      <SectionWrapper eyebrow={content.home.offers.eyebrow} title={content.home.offers.title} subtitle={content.home.offers.subtitle}>
        <AnimatedContainer className="premium-grid-products"><ProductGrid products={saleProducts} /></AnimatedContainer>
      </SectionWrapper>

      <SectionWrapper eyebrow={content.home.collections.eyebrow} title={content.home.collections.title} subtitle={content.home.collections.subtitle} tone="soft">
      ...
      <SectionWrapper eyebrow={content.home.bestSellers.eyebrow} title={content.home.bestSellers.title} subtitle={content.home.bestSellers.subtitle}>
        <AnimatedContainer className="premium-grid-products"><ProductGrid products={featuredProducts} /></AnimatedContainer>
      </SectionWrapper>

      <SectionWrapper eyebrow={content.home.why.eyebrow} title={content.home.why.title} subtitle={content.home.why.subtitle} tone="dark">
      ...
      <SectionWrapper eyebrow={content.home.certifications.eyebrow} title={content.home.certifications.title} subtitle={content.home.certifications.subtitle} tone="soft">
      ...
      <SectionWrapper eyebrow={content.home.testimonials.eyebrow} title={content.home.testimonials.title} subtitle={content.home.testimonials.subtitle}>
      ...
      <SectionWrapper eyebrow={content.home.journal.eyebrow} title={content.home.journal.title} subtitle={content.home.journal.subtitle} tone="soft">
